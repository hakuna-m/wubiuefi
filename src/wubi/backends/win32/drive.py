...
class Drive(object):
    ...
    def get_volume_information(self):
        ...
        gvi(drive_path, volume_name_buffer, MAX_PATH_NULL,
            ctypes.byref(volume_serial_number), ctypes.byref(maximum_component_length),
            ctypes.byref(file_system_flags), file_system_name_buffer, MAX_PATH_NULL)
        volume_information = (str(volume_name_buffer.value), volume_serial_number.value,
                maximum_component_length.value, file_system_flags.value,
    ...
    def get_free_space(self):
        ...
        free = ctypes.c_int64()
        ctypes.windll.kernel32.GetDiskFreeSpaceExW(unicode(drive_path),
