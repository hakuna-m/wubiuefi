...
typedef union dtpage {
	...
	dtslot_t slot[128];	/* 4096 */
} dtpage_t;			/* union size is 4096 */
...
} xtpage_t;			/* union size is 16 * 256 = 4096 */
...
#define di_gengen	u._file._u1._imap._gengen
			...
			union {
				xtpage_t _xtroot;	/* 4096: (XXX: Is this right? Seems the type should be dtroot_t)*/
				struct {
					u8 unused[16];	/* 16: */
					dxd_t _dxd;	/* 16: */
					union {
